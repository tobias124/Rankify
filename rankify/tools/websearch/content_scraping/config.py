...
class ExtractionConfig:
    """
    Configuration of the extraction strategy of content from a web page.
    """
    name:str
    strategy:ExtractionStrategy

# Default provider, ONLY used when the extraction strategy is LLMExtractionStrategy
DEFAULT_PROVIDER = "openrouter/google/gemini-2.0-flash-lite-001"
DEFAULT_PROVIDER_API_KEY = "OPENROUTER_API_KEY"
...
PROVIDER_MODELS = {
    ...
    "openrouter/google/gemini-2.0-flash-lite-001": os.getenv("OPENROUTER_API_KEY")
}
