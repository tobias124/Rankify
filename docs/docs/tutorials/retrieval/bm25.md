...
- [🧠 Dense Retrievers](dense_retrievers.md) - Try semantic search
- [🤖 Hybrid Retrieval](hybrid.md) - Combine BM25 with dense methods
- [📊 Reranking](../reranking/introduction.md) - Improve BM25 results with neural rerankers
